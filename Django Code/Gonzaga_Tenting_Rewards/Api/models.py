...
class TentGroup(models.Model):
    tenter_1 = models.ForeignKey('UserProfile', on_delete=models.CASCADE,)
    tenter_2 = models.ForeignKey('UserProfile', on_delete=models.CASCADE,)
    tenter_3 = models.ForeignKey('UserProfile', on_delete=models.CASCADE,)
    tenter_4 = models.ForeignKey('UserProfile', on_delete=models.CASCADE,)
    tenter_5 = models.ForeignKey('UserProfile', on_delete=models.CASCADE,)
    tenter_6 = models.ForeignKey('UserProfile', on_delete=models.CASCADE,)
