"""
Django settings for Gonzaga_Tenting_Rewards project.
...
SECRET_KEY = 'cl0)lg(tw)hx7c-2f&@p8ykq3%kx3qt3hfjpm(%f52_llp$q_('
...
ROOT_URLCONF = 'Gonzaga_Tenting_Rewards.urls'
...
# If developing, use a SQLite backend
# else use the the MySQL database
if DEBUG:
    DATABASES = {
        'default': {
